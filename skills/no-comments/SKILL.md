...
1. Spawn adapter delegation with `review` helper with the Comment Sicko rubric (`pstack` → `references/agents/comment-sicko.md`). Pass the scope. Do not restate its rules.
