...
- read/open tool calls against any `SKILL.md` path that appears in the transcript (workspace, user-global, or agent-install trees such as `~/.claude/skills/`, `~/.codex/skills/`, `~/.agents/skills/`, or another host skill directory)
